  ...
  return (
    <div className=" overflow-hidden flex md:flex-row flex-col justify-between items-center sm:my-20 my-4 md:gap-20 gap-12 px-5 lg:px-10 ">
      <div className=" relative">
        <div className=" absolute top-4 left-5 bg-white text-secondry px-3 py-1 rounded-md uppercase tracking-wider">
          {" "}
          Featured Recipe
        </div>
        <img src={FeaturedImg} alt="logofeatures" className=" rounded-md" />
      </div>
      <div className=" text-start sm:w-1/2">
        ...
        <p className=" text-xl mt-4 text-[#5c5c5c]">
          ...
          aspernatur recusandae dolore odio, praesentium harum illo iure ut in
          quisquam earum error perspiciatis. Perferendis doloremque hic totam
          blanditiis odio!
        </p>
